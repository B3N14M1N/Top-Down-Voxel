...
public class ChunkMeshGenerator
{
    ...
    public ChunkMeshGenerator(GenerationData generationData, NativeArray<Voxel> voxels, NativeArray<HeightMap> map)
    {
    ...
    public GenerationData Complete()
    {
        if (IsComplete)
        {
            ...
            GenerationData.flags = GenerationData.flags & ChunkGenerationFlags.Data;
